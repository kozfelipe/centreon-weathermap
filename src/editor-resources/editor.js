...
function attach_click_events()
	...
	jQuery('#link_centreonpick').click(centreonpicker).attr("href","#");
    jQuery('#node_centreonpick').click(nodecentreonpicker).attr("href","#");
...
function centreonpicker()
    {
		
    var host1 = document.getElementById('link_nodename1').firstChild.nodeValue;
    var host2 = document.getElementById('link_nodename2').firstChild.nodeValue;
    if (!newWindow || newWindow.closed)
        {
        newWindow = window.open("", "centreonpicker", "scrollbars=1,status=1,height=400,width=400,resizable=1");
        }
    ...
    if (host1 && host2)
        newWindow.location = "centreon-pick.php?command=link_step1&host1=" + host1 + "&host2=" + host2;
    else
        newWindow.location = "centreon-pick.php?command=link_step1";
    }


function nodecentreonpicker()
    {
    if (!newWindow || newWindow.closed)
        {
        newWindow = window.open("", "centreonpicker", "scrollbars=1,status=1,height=400,width=400,resizable=1");
    ...
    newWindow.location = "centreon-pick.php?command=node_step1";
    }
